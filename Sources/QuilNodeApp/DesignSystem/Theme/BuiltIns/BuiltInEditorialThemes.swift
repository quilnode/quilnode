...
extension QuilTheme {
    ...
    static let shl0ms = makeBuiltIn(
        ...
        style: .init(
            ...
            effects: .init(
                ...
                accentTreatment: "solid", motionScale: 0.8),
            composition: .init(
    ...
    static let nousResearch = makeBuiltIn(
        ...
        style: .init(
            ...
            effects: .init(
                ...
                accentTreatment: "solid", motionScale: 0.85),
            composition: .init(
    ...
    static let classicLight = makeBuiltIn(
        id: "quil.classic.light", name: "Quil Classic", appearance: .light,
        summary: "Quilibrium's cream, burgundy and hot-pink language in daylight.",
        familyID: "quil.classic", author: "QuilNode", tags: ["quilibrium", "native", "light"],
        palette: .init(
            ...
            red: "#D92C52", yellow: "#A56D00", orange: "#D85000", green: "#167D32", cyan: "#1477A8", blue: "#286FC0",
            magenta: "#6330CA",
        ...
        style: .init(
            ...
            corners: .init(control: 12, hero: 20, navigation: 8),
            controls: .init(
                navigationSelectionStyle: "row", selectionFillAlpha: 0.34, selectedBorderWidth: 1, iconScale: 1,
                ringStyle: "gradient", ringThickness: 9),
            surfaces: .init(
                treatment: "solid", borderStyle: "solid", surfaceOpacity: 0.90, elevatedOpacity: 1, borderOpacity: 0.48,
                heroAccentOpacity: 0.10),
            typography: .init(scale: 1, displayDesign: "rounded", dataDesign: "monospaced"),
            effects: .init(
                backdrop: "spotlight", decoration: "none", decorationOpacity: 0, shadow: "soft", shadowOpacity: 0.10,
                accentTreatment: "gradient", motionScale: 1),
            composition: .init(

...
extension QuilTheme {
    static let classic = QuilTheme(
        id: "quil.classic", familyID: "quil.classic", name: "Quil Classic", author: "QuilNode", version: "2.0.0",
        appearance: .dark, summary: "Quilibrium's burgundy, hot pink and cream language, native to the console.",
        tags: ["quilibrium", "native", "dark"],
        colors: .init(
            ...
            warning: Color(themeValue: "#F6E2B3", fallback: .orange),
            danger: Color(themeValue: "#FF4D6D", fallback: .red), info: Color(themeValue: "#DAEEFF", fallback: .blue),
        ...
        metrics: .init(
            sidebarCollapsedWidth: 64, sidebarExpandedWidth: 190, navigationRowHeight: 40,
            controlCornerRadius: 12, heroCornerRadius: 20, spacingScale: 1, borderWidth: 1,
            navigationCornerRadius: 8, panelPadding: 19, panelGap: 16
        ),
        typography: .init(scale: 1, displayDesign: .rounded, dataDesign: .monospaced),
        components: .init(
            navigationSelection: .row, ringStyle: .gradient, surfaceTreatment: .tinted,
            backdropStyle: .spotlight, shadowStyle: .glow, accentTreatment: .gradient,
            selectionFillAlpha: 0.34, selectedBorderWidth: 1, iconScale: 1, ringThickness: 9,
            surfaceOpacity: 0.76, elevatedOpacity: 0.96, borderOpacity: 0.40, heroAccentOpacity: 0.13,
            shadowOpacity: 0.10
        ),
        recipes: .init(),
        isBuiltIn: true

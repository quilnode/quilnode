...
extension IdentityTransactionPresentation {
    ...
    static func importKeyset(_ inspection: KeysetInspection) -> Self {
    ...
    static func activate(_ keyset: ManagedKeyset) -> Self {
        Self(
            kind: .activate,
    ...
    static func adopt(_ keyset: ManagedKeyset) -> Self {
        Self(
            kind: .adopt,

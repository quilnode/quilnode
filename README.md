...
<p align="center">
  <strong><a href="https://github.com/quilnode/quilnode/releases/tag/v0.1.0-alpha.4">Download QuilNode 0.1.0-alpha.4</a></strong>
...
```sh
git -c gpg.ssh.allowedSignersFile=config/release/allowed-signers tag -v v0.1.0-alpha.4
```
